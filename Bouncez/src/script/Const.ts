...
/**跳板模型材质 */
export const URL_BoardMaterial: string = "res/texture/game/board.png";
/**弹簧螺旋模型 */
...
/**玩家冲刺跳跃Y角度自转幅度 */
export const PlayerSprintStepY: number = 10;
...
/**跳板半径 */
export const BoardRadius: number = 1.5;
/**跳板高度 */
...
/**跳板总数 */
export const BoardNum: number = 6;
/**跳板新建索引: 当当前跳板达到该值即新建 */
...
/**冲击波特效帧数 */
export const BoardWaveFrames: number = 16;
/**内圈冲击波特效开始帧数 */
export const BoardWaveInnerStartFrames: number = 8;
/**冲击波特效幅度 */
export const BoardWaveStep: number = 0.15;
/**内圈冲击波特效幅度 */
...
/**钻石碎片数量 */
export const DiamondPieceNum: number = 10;
/**钻石冲刺时Y方向步进 */
